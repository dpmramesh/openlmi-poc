...
wsdl = 'file:/home/sarnoso/HACK/openlmi-poc.git/openlmi-condor/test/test-aviary/wsdl/services/job/aviary-job.wsdl'

parser = build_basic_parser('Submit a sample job remotely via SOAP.','http://mncars002:9090/services/job/submitJob')
