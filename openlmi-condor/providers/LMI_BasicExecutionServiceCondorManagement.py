"""Python Provider for LMI_BasicExecutionServiceCondorManagement

Instruments the CIM class LMI_BasicExecutionServiceCondorManagement
...
class LMI_BasicExecutionServiceCondorManagement(CIMProvider2):
    """Instrument the CIM class LMI_BasicExecutionServiceCondorManagement 
    ...
    def enum_instances(self, env, model, keys_only):
        ...
        model.path.update({'VirtualMemory': None, 'PhysicalMemory': None,
            'Name': None, 'CPUArchitecture': None, 'CommonName': None,
            'CPUCount': None, 'SystemName': None, 'CPUSpeed': None,
            'CreationClassName': None, 'OperatingSystem': None,
        ...
        while False: # TODO more instances?
            ...
            model['CreationClassName'] = 'LMI_BasicExecutionServiceCondorManagement'    
    ...
    def cim_method_requeststatechange(self, env, object_name,
        ...
        """Implements LMI_BasicExecutionServiceCondorManagement.RequestStateChange()
    ...
    def cim_method_startservice(self, env, object_name):
        """Implements LMI_BasicExecutionServiceCondorManagement.StartService()
    ...
    def cim_method_changeaffectedelementsassignedsequence(self, env, object_name,
        ...
        """Implements LMI_BasicExecutionServiceCondorManagement.ChangeAffectedElementsAssignedSequence()
...
## end of class LMI_BasicExecutionServiceCondorManagementProvider
    
## get_providers() for associating CIM Class Name to python provider class name
    
def get_providers(env): 
    lmi_basicexecutionservicecondormanagement_prov = LMI_BasicExecutionServiceCondorManagement(env)  
    return {'LMI_BasicExecutionServiceCondorManagement': lmi_basicexecutionservicecondormanagement_prov} 
